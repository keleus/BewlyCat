...
export const VIDEO_PAGE_PARTITION_DATA_REQUEST = 'bewlyVideoPagePartitionDataRequest'
export const VIDEO_PAGE_PARTITION_DATA_RESPONSE = 'bewlyVideoPagePartitionDataResponse'
