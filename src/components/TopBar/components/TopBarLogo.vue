...
<template>
  <div
    ...
    class="top-bar-logo"
  >
    <div class="top-bar-logo__fixed" data-top-bar-fixed>
      <div
        ...
        >
          ...
          >
            ...
            <Transition name="slide-in">
              <ChannelsPop
                v-if="!isLayoutEditing && popupVisible.channels"
                class="bew-popover"
      ...
      <BewlyOrBiliPageSwitcher :force-white-icon="forceWhiteIcon" :compact="compact" z-1 />
    </div>

    <TopBarPinnedChannels :force-white-icon="forceWhiteIcon" :available-width="pinnedWidth" :compact="compact" />
  </div>
</template>
