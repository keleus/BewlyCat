...
<template>
  <div
    ...
    class="top-bar-logo"
  >
    <div class="top-bar-logo__base" data-top-bar-pin-base>
      <div flex="~ items-center gap-2 shrink-0" z-1>
        <div
          ref="channels"
          relative w-fit
    ...
    <TopBarPinnedChannels :force-white-icon="forceWhiteIcon" :available-width="pinnedAvailableWidth" />
  </div>
</template>
