...
function handleToggleComponent(componentKey: string) {
      ...
      <template #bottom>
        ...
        >
          <div
            ...
            duration-300
            :style="{
              background: getComponentConfig(component.key)?.visible ? 'var(--bew-theme-color-20)' : 'var(--bew-fill-1)',
              color: getComponentConfig(component.key)?.visible ? 'var(--bew-theme-color)' : 'var(--bew-text-1)',
            }"
            @click="handleToggleComponent(component.key)"
          >
